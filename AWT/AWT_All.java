...
public class AWT_All
{
    ...
    public AWT_All()
    {
        mainFrame = new Frame("Linus Infosystems");
    ...
    private class MyListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            {
                statusLabel.setText("Logic Development batch selected");
            }
            else if( command.equals( "P" ) )
            {
                statusLabel.setText("Python With Automation And Machine Learning");
            }  	
        }		
    }
}
